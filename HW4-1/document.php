...
<body>
    <div class="container">
        <h1>คำสั่งแต่งตั้ง | <a href='newdocument.php'><span class='glyphicon glyphicon-plus'></span></a></h1>
            ...
            $table = "<table class='table table-hover'>
                        <thead>
                            <tr>
                                ...
                                <th scope='col'>หน้าจัดการข้อมูลคำสั่งแต่งตั้ง</th>
                                <th scope='col'>ข้อมูลบุคลากร</th>
                            </tr>
                        </thead>
                        <tbody>";
