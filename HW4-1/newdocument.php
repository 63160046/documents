    ...
    <div class="container">
        ...
        <form action="newdocument.php" method="post">
            <div class="form-group">
                <label for="doc_num">Number order</label>
            ...
            <div class="form-group">
                <label for="doc_start_date">Start date order</label>
                <input type="text" class="form-control" name="doc_start_date" id="doc_start_date">
            </div>
            <div class="form-group">
                <label for="doc_to_date">Last date order</label>
            ...
            <div class="form-group">
                <label for="doc_file_name">Document name</label>
